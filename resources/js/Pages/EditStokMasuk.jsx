...
export default function EditStokMasuk({ stockin }) {
    ...
    <>
      ...
      <Container className="flex flex-col items-start gap-5">
        ...
        <Card className="w-1/2">
          <CardHeader>
            <CardTitle>Form edit barang masuk</CardTitle>
            <CardDescription>
              Silahkan ubah atau edit data barang masuk
            </CardDescription>
          </CardHeader>
          <CardContent>
            <form
...
EditStokMasuk.layout = (page) => <App children={page} />;
